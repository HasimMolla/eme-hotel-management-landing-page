  ...
  return (
      <div className='w-full  max-w-[1380px] mx-auto flex flex-col items-center py-14 px-5 md:px-24'>
          <div className="w-full h-[500px] md:h-[350px]  bg-white  shadow-2xl  rounded-xl flex flex-col md:flex-row items-center justify-between  overflow-hidden">
              ...
              <div className="w-full md:w-[30%] h-[40%] md:h-full flex flex-col gap-y-2 px-14 py-2 justify-center items-center" >
                  ...
                  <div className=" text-[#2251FF] leading-10 text-5xl  font-bold ">
                  ...
                  <div className="text-[#232D63] text-base font-bold text-center">
                      ...
                      <p>of the year - 2024</p>
                  </div>
              </div>

              <div className='w-full md:w-[70%] h-[60%] md:h-full relative'>
                  <Image
                      className="w-full h-full object-fill md:object-cover object-right-top md:object-center  relative z-10"
                      width={500}
                      height={500}
                      src={rewardOne}
                      alt="student Img" />
                  ...
                  <Image
                      className="absolute bottom-0 right-0 w-[150px] md:w-[250px] rounded-md object-cover object-center  z-20"
                      width={500}
                      height={500}
                      src={rewardTwo}
                      alt="student Img" />
